...
import 'zxzm_logic.dart';
import 'zxzm_state.dart';

class ZxzmPage extends BaseStateless {
  ZxzmPage({super.key}) : super(title: '资信证明');

  final ZxzmLogic logic = Get.put(ZxzmLogic());
  final ZxzmState state = Get.find<ZxzmLogic>().state;
  ...
  List<Widget>? get rightAction => [
    SizedBox(width: 15.w,),
    const Center(
      child: BaseText(text: '申请记录', fontSize: 16, color: Color(0XFF005DDA),),
    ),
    SizedBox(width: 15.w,),
  ];
