...
import 'lc_logic.dart';
import 'lc_state.dart';

class LcPage extends BaseStateless {
  LcPage({super.key}) : super(title: '理财');

  final LcLogic logic = Get.put(LcLogic());
  final LcState state = Get.find<LcLogic>().state;
