              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Row(
                    ...
                    children: [
                      const BaseText(text: '2026年', fontSize: 14, color: Color(0xFF333333), fontWeight: FontWeight.w500),
                      const BaseText(text: '共', fontSize: 14, color: Color(0xFF999999))
                          .marginOnly(left: 13.w),
                      const BaseText(text: '0', fontSize: 14, color: Color(0xFF333333))
                          .marginOnly(left: 2.w),
                ...
                _amount(left: 80, top: 255, text: '0.00', fontSize: 20),
                _amount(left: 540, top: 255, text: '0.00', fontSize: 20),
                _amount(left: 175, top: 360, text: '0.00', fontSize: 14),
              ],
            ),
          ),
        ],
